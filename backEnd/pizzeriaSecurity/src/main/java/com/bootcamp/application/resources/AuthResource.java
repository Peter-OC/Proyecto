...
import com.bootcamp.application.dtos.FunctionEditDTO;
import com.bootcamp.application.dtos.PasswordDTO;
import com.bootcamp.application.dtos.ProfileDTO;
import com.bootcamp.application.dtos.UserCreateDTO;
import com.bootcamp.application.dtos.UserEditDTO;
...
public class AuthResource {
	...
	private String getJWTToken(User usr) {
		...
		String token = Jwts.builder()
				...
				.setExpiration(new Date(System.currentTimeMillis() + 6600000))
